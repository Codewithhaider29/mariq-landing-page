...
export function MailboxSection() {
  return (
    <section className="py-24 md:py-32 bg-[#050505] overflow-hidden flex flex-col justify-center relative border-t border-white/5">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Top Headline */}
        <div className="mb-20 md:mb-0 md:absolute md:top-0 md:left-4 z-20 pointer-events-none">
          <motion.h2 
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-end relative min-h-[500px]">
          
          {/* --- LEFT: Sliding Data Cards --- */}
          {/* On Desktop: They slide out from behind the box. On Mobile: They stack below. */}
          <div className="w-full lg:w-auto lg:absolute lg:right-[380px] flex flex-col gap-4 z-10 mb-12 lg:mb-0 perspective-1000">
            {solutions.map((card, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ 
                    delay: 0.5 + (index * 0.2), // Staggered after box appears
                    type: "spring", 
                    stiffness: 120, 
                    damping: 20 
                  }}
                  whileHover={{ x: -10, scale: 1.02, borderColor: "rgba(204, 255, 0, 0.5)" }}
                  className="w-full md:w-[350px] p-6 rounded-2xl bg-[#121212] border border-white/10 shadow-2xl backdrop-blur-md group cursor-pointer relative overflow-hidden"
                >
                  {/* Hover Glow Gradient */}
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                        <p className="font-mono text-[#CCFF00] text-xs uppercase tracking-widest mb-1">{card.subtitle}</p>
                        <h3 className="font-oswald text-2xl text-white uppercase leading-none">{card.title}</h3>
                    </div>
          ...
          <div className="relative z-20 transform scale-90 md:scale-110 lg:translate-x-10">
            <IndustrialBox />
          </div>
        ...
        <motion.div 
           ...
           className="mt-12 text-center lg:text-right lg:pr-20"
        >
            <p className="text-gray-500 text-sm mb-4">Ready to receive your custom strategy?</p>
            <button className="text-white border-b border-[#CCFF00] pb-1 hover:text-[#CCFF00] transition-colors flex items-center gap-2 ml-auto mr-auto lg:mr-0">
